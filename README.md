...
기능적 요구사항
1. 고객이 영화 및 좌석을 선택하고 예매를 요청한다. (status: 예매요청함)
1. 예매 요청 내역이 my page에 전달된다.
1. 고객이 결제를 진행한다.
1. 결제가 완료되면 my page에 전달된다 (status: 예매완료됨)
1. 영화관에서 나의 예매 정보로 티켓을 수령한다 (status: 티켓수령함)
1. 고객이 예매를 취소할 수 있다 (티켓 수령 전)
1. 예매가 취소되면 예매 정보가 사라진다
1. 고객이 예매 내역을 중간중간 조회할 수 있다
